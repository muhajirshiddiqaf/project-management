...
const quotationSchemas = {
  ...
  createQuotation: Joi.object({
    ...
    tax_rate: Joi.number().min(0).max(100).default(10),
    ...
    currency: Joi.string().valid('USD', 'IDR', 'EUR', 'GBP').default('USD'),
    ...
    items: Joi.array().items(
      Joi.object({
        ...
        unit: Joi.string().valid('item', 'hour', 'day', 'month', 'project').required(),
  ...
  updateQuotation: Joi.object({
    ...
    quotation_number: Joi.string().optional().max(50),
    subject: Joi.string().optional().min(3).max(200),
    description: Joi.string().optional().max(2000),
    ...
    currency: Joi.string().valid('USD', 'IDR', 'EUR', 'GBP').optional(),
    notes: Joi.string().optional().max(1000),
    terms_conditions: Joi.string().optional().max(2000)
  }),
